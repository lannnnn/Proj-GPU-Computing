...
int main( int argc, char *argv[] ) {
   ...
   if(irank==0) {
      iadj = new int[6] {0, 2, 5, 8, 11, 13};
      jadj = new int[13] {1, 5, 0, 2, 6, 1, 3, 7, 2, 4, 8, 3, 9};
   }
   else if(irank==1) {
      iadj = new int[6] {0, 3, 7, 11, 15, 18};
      jadj = new int[18] {0, 6, 10, 1, 5, 7, 11, 2, 6, 8, 12, 3, 7, 9, 13, 4, 8, 14};
   }
   else {
      iadj = new int[6] {0, 2, 5, 8, 11, 13};
      jadj = new int[13] {5, 11, 6, 10, 12, 7, 11, 13, 8, 12, 14, 9, 13};
   }
